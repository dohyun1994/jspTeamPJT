...
<body>
	...
	<div class="jumbotron" class="image">
		<div class="container" align="center">
			<h1 class="display-3 font-weight-bold text-white">회원가입</h1>
		</div>
	</div>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"  action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="password" id="passwd" type="text" class="form-control" placeholder="password" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<input type="submit" class="btn btn-warning " value="등록 " style="color : #8B4513"> 
					<input type="reset" class="btn btn-warning " value="취소 " style="color : #8B4513" onclick="reset()" >
				</div>
			</div>
		</form>
	</div>
