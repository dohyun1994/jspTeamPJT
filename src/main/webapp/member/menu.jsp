				...
				<div class="dropdown-menu">
					<c:choose>
						<c:when test="${empty sessionId }">
							<a class="dropdown-item" href="loginMember.jsp">Login</a> 
							<a class="dropdown-item" href="addMember.jsp">회원가입</a>
						</c:when> 
						<c:otherwise>
							<span style="padding-top: 7px; color: white">[<%=sessionId %>님]</span>
							<a class="dropdown-item" href="logoutMember.jsp">Logout</a>
							<a class="dropdown-item" href="updateMember.jsp">회원정보수정</a>
